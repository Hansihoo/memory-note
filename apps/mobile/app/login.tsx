  ...
  return (
    <View style={styles.screen}>
      ...
      <Pressable disabled={submitting} onPress={submit} style={styles.primaryButton}>
        {submitting ? <ActivityIndicator color="#FFFFFF" /> : <Text style={styles.primaryButtonText}>로그인</Text>}
      </Pressable>
      <Pressable onPress={() => router.replace("/register")} style={styles.linkButton}>
